      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 py-1">
          ...
          <div className="relative">
            <i className="fa fa-user-circle text-gray-600 text-lg cursor-pointer"
            onClick={handleUserIconClick}></i>
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                {isSignedIn ? (
                  <div className="p-2 space-y-1">
                    ...
                    <button className="block w-full text-left px-4 py-2 text-blue-600 hover:bg-gray-100 rounded-md" onClick={() => setIsSignedIn(false)}>
                      Logout
                    </button>
                  </div>
                ) : (
                  <div className="p-2 space-y-1">
                    <a href="/../auth/signup" className="block px-4 py-2 text-blue-600 hover:bg-gray-100 rounded-md">Sign Up</a>
                    <a href="/../auth/login" className="block px-4 py-2 text-blue-600 hover:bg-gray-100 rounded-md">Login</a>
                  </div>
                )}
              </div>
            )}
